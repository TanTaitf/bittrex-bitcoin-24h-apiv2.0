...
public class NewsTopActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String url = getIntent.getStringExtra("id");
...
//                new FinestWebView.Builder(NewsTopActivity.this).titleDefault("The Finest Artist")
//                        .show("http://thefinestartist.com");

//
//                new FinestWebView.Builder(NewsTopActivity.this).theme(R.style.RedTheme)
...
//                customTabsIntent.launchUrl(NewsTopActivity.this, Uri.parse(url));
            }
        });
